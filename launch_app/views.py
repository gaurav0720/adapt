...
def index(request):
    if request.method == 'POST':
        if 'contact_name' in request.POST:
            ...
            EmailHelper.send_uab_message_gmail('New user contacted at ADAPT Marketplace', contact_message, 'adaptmarketplace@gmail.com', ['ADAPTMarketplace@uabmc.edu', 'adaptmarketplace@gmail.com'], fail_silently=False)
